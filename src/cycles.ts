...
export class QuickItemCycle extends Cycle {
    ...
    useOptimalPotion(item: Form | null): boolean {
        ...
        let actorValueWord = "";
        if (potionTypeID === consts.RESTORE_HEALTH_ID || potionTypeID === consts.ULTIMATE_HEALING_ID) {
            actorValueWord = "Health";
        } else if (potionTypeID === consts.RESTORE_MAGICKA_ID || potionTypeID === consts.ULTIMATE_MAGICKA_ID) {
            actorValueWord = "Magicka";
        } else if (potionTypeID === consts.RESTORE_STAMINA_ID || potionTypeID === consts.ULTIMATE_STAMINA_ID) {
